 ...
 *   <li>{@link express.mvp.roray.ffm.utils.functions.DowncallFactory} - Factory for creating
 *       downcall handles
 *   <li>{@link express.mvp.roray.ffm.utils.functions.LinuxLayouts} - Pre-defined layouts for
 *       Linux/C types and structs
 *   <li>{@link express.mvp.roray.ffm.utils.functions.UpcallFactory} - Factory for creating upcall
 *       stubs
 * </ul>
 *
 ...
 *       interpreting errno
 *   <li>{@link express.mvp.roray.ffm.utils.functions.StructAccessor} - VarHandle-based struct field
 *       accessors
 *   <li>{@link express.mvp.roray.ffm.utils.functions.CriticalSafe} - Annotation marking functions
 *       safe for critical mode
 *   <li>{@link express.mvp.roray.ffm.utils.functions.NeverCritical} - Annotation marking functions
 *       that should NOT use critical mode
 * </ul>
 *
