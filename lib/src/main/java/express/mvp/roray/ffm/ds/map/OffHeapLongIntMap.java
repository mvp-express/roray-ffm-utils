...
public interface OffHeapLongIntMap extends AutoCloseable {
     ...
     *
     * @param key The key.
     * @return A packed long where bit 63 (MSB) is the "found" flag and bits 0-31 contain the int
     *     value. If the key is not found, the MSB is 0. Example:
     *     <pre>{@code
    ...
    /**
     * Removes the key &amp; returns its value in the same packed format as {@link
     * #getPacked(long)}.
     *
